...
// ADD YOUR ARMOUR VALUES TO THIS PART

switch (vest _unit) do
{
    case "82nd_M52D_Stealth_BLK": { 
        _unit setVariable ["tts_cloak_cooldown", 30, true];
        _unit setVariable ["tts_cloak_duration", 60, true];
    };
    case "82nd_M52D_Mesa_BLK": { 
        _unit setVariable ["tts_cloak_cooldown", 5, true];
        _unit setVariable ["tts_cloak_duration", 300, true];
    };
    default {};
};
